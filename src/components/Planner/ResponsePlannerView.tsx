        ...
        {currentIncident && plan ? (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div className="planner-pipeline-container" style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <div className="card planner-stage-assessment" style={{ padding: '1.25rem', background: 'var(--bg-card)', border: '1px solid var(--border-subtle)' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.75rem', borderBottom: '1px solid var(--border-subtle)', paddingBottom: '0.5rem' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '0.85rem' }}>
                  <div>
                    ...
                    <div style={{ fontSize: '0.85rem', color: 'var(--text-primary)', lineHeight: 1.4, background: 'var(--bg-surface-elevated)', padding: '0.75rem', borderRadius: '6px', border: '1px solid var(--border-subtle)' }}>
                  ...
                  <div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', background: 'var(--bg-surface-elevated)', padding: '0.75rem', borderRadius: '6px', border: '1px solid var(--border-subtle)', fontSize: '0.8rem' }}>
                ...
                <div style={{ background: 'rgba(239, 68, 68, 0.12)', border: '1px solid rgba(239, 68, 68, 0.3)', padding: '0.75rem 1rem', borderRadius: '8px', color: '#fca5a5', fontSize: '0.78rem', display: 'flex', alignItems: 'flex-start', gap: '0.6rem' }}>
                  ...
                  <div>
                    <strong style={{ color: 'var(--text-primary)', textTransform: 'uppercase', fontSize: '0.72rem', letterSpacing: '0.04em' }}>Automated Escalation Trigger Condition:</strong>
              ...
              <div className="card planner-stage-recommendation" style={{ padding: '1.25rem', background: 'var(--bg-card)', border: '1px solid var(--border-subtle)' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.85rem', marginBottom: '1rem' }}>
                  ...
                  <div style={{ background: 'var(--bg-surface-elevated)', padding: '0.75rem', borderRadius: '8px', border: '1px solid var(--border-subtle)' }}>
                    ...
                    <div style={{ fontSize: '0.82rem', fontWeight: 600, color: 'var(--text-primary)', marginTop: '0.2rem' }}>
                    ...
                    {(plan.recommendedActions && plan.recommendedActions.length > 0
                      ...
                      <div
                        ...
                        style={{
                          ...
                          background: actionItem.isAiRecommendation ? 'rgba(139, 92, 246, 0.12)' : 'var(--bg-surface-elevated)',
                          borderRadius: '8px',
                      ...
                      <tbody>
                        {(plan.requiredResources && plan.requiredResources.length > 0
                          ...
                          <tr key={i} style={{ borderBottom: '1px solid var(--border-subtle)' }}>
                            <td style={{ padding: '0.55rem 0.6rem', fontWeight: 600, color: 'var(--text-primary)' }}>{res.item}</td>
                ...
                {plan.publicCommunication && (
                  <div style={{ background: 'var(--bg-surface-elevated)', border: '1px solid var(--border-subtle)', padding: '0.85rem', borderRadius: '8px' }}>
                    ...
                    <div style={{ fontSize: '0.82rem', color: 'var(--text-primary)', fontStyle: 'italic', marginBottom: '0.4rem', lineHeight: 1.3 }}>
              ...
              <div className="card planner-stage-impact" style={{ padding: '1.25rem', background: 'var(--bg-card)', border: '1px solid var(--border-subtle)' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '0.85rem', fontSize: '0.78rem' }}>
                  <div style={{ background: 'var(--bg-surface-elevated)', padding: '0.75rem', borderRadius: '8px', border: '1px solid var(--border-subtle)' }}>
        ...
        <div style={{
          ...
          <div className="card" style={{ width: '100%', maxWidth: '500px', padding: '1.5rem', background: 'var(--bg-surface-elevated)', border: '1px solid #ef4444' }}>
            ...
            <textarea
              ...
              style={{ width: '100%', padding: '0.6rem', borderRadius: '6px', background: 'var(--bg-canvas)', border: '1px solid var(--border-subtle)', color: 'var(--text-primary)', fontSize: '0.82rem', marginBottom: '1rem' }}
            />
