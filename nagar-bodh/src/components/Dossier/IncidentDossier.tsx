      ...
      <div className="fact-section">
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.4rem' }}>
            <span style={{ fontSize: '0.74rem', fontWeight: 700, textTransform: 'uppercase', color: isP1 ? '#fca5a5' : 'var(--cyan-400)' }}>
          ...
          <div style={{ fontSize: '0.72rem', color: '#cbd5e1', marginBottom: '0.6rem' }}>
            Level: <strong style={{ color: isP1 ? '#f87171' : 'var(--cyan-400)', textTransform: 'uppercase' }}>{priority.level}</strong> • {priority.formulaExplanation}
          </div>

          {/* Factor Breakdown Bars */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem', fontSize: '0.68rem', marginBottom: '0.65rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span>Base Severity Factor:</span>
              <strong style={{ fontFamily: 'var(--font-mono)' }}>{priority.factors.severityScore} / 25</strong>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span>Critical Asset Proximity:</span>
              <strong style={{ fontFamily: 'var(--font-mono)', color: '#c084fc' }}>{priority.factors.assetVulnerabilityScore} / 25</strong>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span>Precipitation Multiplier:</span>
              <strong style={{ fontFamily: 'var(--font-mono)' }}>{priority.factors.weatherRiskScore} / 15 ({currentStep.weatherCondition.rainfallMmPerHour} mm/hr)</strong>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              <span>Historical Vulnerability:</span>
              <strong style={{ fontFamily: 'var(--font-mono)' }}>{priority.factors.historicalRecurrenceScore} / 10</strong>
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: '0.82rem', lineHeight: 1.5, color: '#cbd5e1', marginBottom: '1rem' }}>
              Priority is calculated using a 5-factor deterministic formula. It requires zero black-box LLM guessing:
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem', fontSize: '0.78rem', marginBottom: '1.2rem', fontFamily: 'var(--font-mono)' }}>
              <div style={{ padding: '0.5rem', background: 'rgba(0,0,0,0.3)', borderRadius: '6px' }}>
                <strong>1. Base Severity Score (0-25):</strong> Derived from NLP sentiment & reported hazard level.
              </div>
              <div style={{ padding: '0.5rem', background: 'rgba(0,0,0,0.3)', borderRadius: '6px' }}>
                <strong>2. Velocity Surge Score (0-25):</strong> Computed from report arrival frequency delta over baseline.
              </div>
              <div style={{ padding: '0.5rem', background: 'rgba(0,0,0,0.3)', borderRadius: '6px' }}>
                <strong>3. Critical Asset Vulnerability (0-25):</strong> Haversine distance to schools, hospitals, and Metro stations.
              </div>
              <div style={{ padding: '0.5rem', background: 'rgba(0,0,0,0.3)', borderRadius: '6px' }}>
                <strong>4. Precipitation Multiplier (0-15):</strong> Live rainfall telemetry ({currentStep.weatherCondition.rainfallMmPerHour} mm/hr).
              </div>
              <div style={{ padding: '0.5rem', background: 'rgba(0,0,0,0.3)', borderRadius: '6px' }}>
                <strong>5. Historical Recurrence Score (0-10):</strong> Resolved incident frequency in current ward zone.
              </div>
            </div>
